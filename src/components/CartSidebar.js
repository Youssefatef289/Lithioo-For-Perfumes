            ...
            <>
                ...
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <button
                        type="button"
                        className="text-start text-sm font-semibold text-neutral-800 hover:text-brand dark:text-neutral-100"
                        onClick={() => handleProductClick(item.id)}
                      >
                        {item.name}
                      </button>
              ...
              <div className="border-t border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-900">
                <div className="mb-4 flex items-center justify-between text-lg font-bold text-neutral-800 dark:text-white">
                  <span>Total:</span>
                  <span className="text-brand">${getCartTotal().toFixed(2)}</span>
                </div>
